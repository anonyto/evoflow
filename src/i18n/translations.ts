export const translations = {
  fr: {
    ...
    services: {
      title: "Nos solutions d'automatisation IA",
      subtitle: "Des solutions intelligentes pour automatiser votre business",
      items: [
        {
  ...
  en: {
    ...
    services: {
      ...
      subtitle: "Smart solutions to automate your business",
      items: [
        {
